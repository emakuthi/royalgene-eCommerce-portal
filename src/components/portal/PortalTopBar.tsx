...
export default function PortalTopBar() {
  ...
  const routes: Record<string, { title: string; description?: string }> = {
    ...
    '/sales/new': { title: 'Record Sale', description: 'Enter sale details' },
    '/stock': { title: 'Inventory', description: 'Manage stock levels' },
    '/stock/add-new': { title: 'Add Product', description: 'Create a new product' },
    '/shops/add-new': { title: 'Add Shop', description: 'Create a new shop' },
    '/alerts/new': { title: 'New Alert', description: 'Create a new alert' },
