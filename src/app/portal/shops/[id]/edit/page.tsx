...
export default function EditShopPage() {
  ...
  return (
    <div className="w-full bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 min-h-screen">
      <PortalHeader backHref="/portal/shops" title="Edit Shop" description={`Edit shop ${id}`} breadcrumbs={[{ label: 'Portal', href: '/portal' }, { label: 'Shops', href: '/portal/shops' }, { label: 'Edit' }]} />
