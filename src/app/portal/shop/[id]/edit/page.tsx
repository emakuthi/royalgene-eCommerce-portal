    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 p-6">
      <div className="max-w-xl text-center">
        ...
        <div className="flex justify-center gap-2">
          <a href="/portal/shops" className="inline-block px-4 py-2 rounded-md border border-input bg-transparent">Back to Shops</a>
          <a href="/portal/shops" className="inline-block px-4 py-2 rounded-md bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))]">Open Shops</a>
        </div>
      </div>
    </div>
  );
